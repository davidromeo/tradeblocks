 ...
 * Tier 2: Computes VIX regime fields in market.context (Vol_Regime, Term_Structure_State, VIX_IVR, VIX_IVP, VIX9D/VIX3M IVR/IVP, etc.)
  ...
  server.registerTool(
    "enrich_market_data",
    {
      description:
        ...
        "Tier 2 (if VIX data in market.context) computes VIX regime fields: Vol_Regime, Term_Structure_State, VIX_IVR, VIX_IVP, VIX9D_IVR, VIX9D_IVP, VIX3M_IVR, VIX3M_IVP, VIX_Gap_Pct, VIX_Change_Pct, VIX ratios, VIX_Spike_Pct. " +
