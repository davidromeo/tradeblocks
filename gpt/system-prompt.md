...
Browser-based options trading analyzer. Upload CSVs → get statistics, charts, Monte Carlo, walk-forward analysis, Kelly sizing. All data stays local (IndexedDB). Open source: gitlab.com/davidromeo/tradeblocks
