...
| 72. Exit Policy Comparison | v2.2 | 0/3 | Planning   | — |
...
Plans:
- [ ] 72-01-PLAN.md — Option bar caching in replay + batch exit analysis pure engine
- [ ] 72-02-PLAN.md — Unit tests for batch exit analysis engine
