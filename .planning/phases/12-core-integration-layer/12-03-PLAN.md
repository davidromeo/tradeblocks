...
return {
  content: [
    { type: "text", text: "## Performance Charts\n..." },  // Markdown for display
...
Follow the pattern established in 12-02 analysis tools.
...
- Return: Selected chart data as structured markdown tables + JSON resource with numerical data
...
- Return: Daily comparison table, total variance, correlation + JSON resource with numerical data
